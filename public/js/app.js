...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    updateOrCreate: function updateOrCreate() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/create-update-user', this.formData).then(function () {
        _this.post = {};

        _this.updateListUser();
      })["catch"](function (error) {
        if (error.response.status == 422) {
          _this.errors.save(error.response.data.errors);
        }
      });
    },
    ...
    detete: function detete(userId) {
      var _this2 = this;

      var result = confirm("Want to delete User?");

      if (result) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post('/delete', {
          id: userId
        }).then(function () {
          _this2.updateListUser();
        });
      }
    },
    updateListUser: function updateListUser() {
      var _this3 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/update-list-user').then(function (response) {
        _this3.userList = response.data;
      });
    },
    updateListRole: function updateListRole() {
      var _this4 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/update-list-role').then(function (response) {
        _this4.roleList = response.data;
      });
    },
    updateOrCreateRole: function updateOrCreateRole() {
      var _this5 = this;
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/create-update-role', this.formData).then(function () {
        _this5.role = {};

        _this5.updateListRole();
      })["catch"](function (error) {
        if (error.response.status == 422) {
          _this5.errors.save(error.response.data.errors);
        }
      });
    },
    ...
    deteteRole: function deteteRole(roleId) {
      var _this6 = this;

      var result = confirm("Want to delete Role?");

      if (result) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().post('/delete-role', {
          id: roleId
        }).then(function () {
          _this6.updateListRole();
        });
      }
    }
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/login', this.formData).then(function () {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    register: function register() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/register', this.formData).then(function () {
        window.location.href = '/home';
      })["catch"](function (error) {
        if (error.response.status == 422) {
          _this.errors.save(error.response.data.errors);
...
var app = new vue__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  components: {
    ...
    Register: _components_Register_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex" }, [
    _c("div", { staticClass: "mx-auto mt-6 pt-4 w-1/4" }, [
      _c("h3", { staticClass: "text-xl mb-5" }, [_vm._v("Add User")]),
      _vm._v(" "),
      _c("div", { staticClass: "flex flex-wrap -mx-3 mb-6" }, [
        _c("div", { staticClass: "w-full md:w-full px-3 mb-6" }, [
          ...
          _c("label", {
            staticClass:
              "block uppercase tracking-wide text-red-600 text-xs font-bold mb-2",
          ...
          _c("input", {
            ...
            staticClass:
              "appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500",
            attrs: {
              id: "grid-text-1",
              type: "email",
        ...
        _c("div", { staticClass: "w-full md:w-full px-3 mb-6" }, [
          ...
          _c(
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.post.role_id,
                  expression: "post.role_id"
                }
              ],
              staticClass:
                "appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500",
            ...
            _vm._l(_vm.roleList, function(role, i) {
              return _c("option", { key: i, domProps: { value: role.id } }, [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "w-full md:w-full px-3 mb-3" }, [
          _c(
            "label",
            {
              staticClass:
      ...
      _c(
        ...
        {
          staticClass:
            "appearance-none bg-gray-200 text-gray-900 px-4 py-2 shadow-sm border border-gray-400 rounded-md mr-3",
          attrs: { type: "submit" },
          on: {
            click: function($event) {
              return _vm.updateOrCreate()
            }
          }
        },
        [_vm._v("Save")]
      ...
      _vm._v(" "),
      _c("h3", { staticClass: "text-xl mt-10 mb-5" }, [_vm._v("Add Role")]),
      _vm._v(" "),
      _c("div", { staticClass: "flex flex-wrap -mx-3 mb-6" }, [
        _c("div", { staticClass: "w-full md:w-full px-3 mb-6" }, [
          _c(
    ...
    _c("div", { staticClass: "w-1/2" }, [
      _c(
        "div",
        [
          _c("h3", { staticClass: "text-xl mt-10 mb-5" }, [
            _vm._v("User List")
          ]),
          _vm._v(" "),
          _vm._m(0),
          ...
          _vm._l(_vm.userList, function(user, index) {
            return _c(
              "div",
              { key: index, staticClass: "flex justify-between" },
              [
                _c("p", [_vm._v(_vm._s(user.id))]),
                _vm._v(" "),
                _c("p", [_vm._v(_vm._s(user.name))]),
                _vm._v(" "),
                _c("p", [_vm._v(_vm._s(user.email))]),
                _vm._v(" "),
                _c("p", [_vm._v(_vm._s(user.role ? user.role.name : ""))]),
                _vm._v(" "),
                _c("div", { staticClass: "cursor-pointer" }, [
                  _c(
                    "span",
                    {
                      staticClass: "text-green-500 mr-3",
                      on: {
                        click: function($event) {
      ...
      _c(
        ...
        [
          ...
          _vm._m(1),
          _vm._v(" "),
          _vm._l(_vm.roleList, function(role, ii) {
            return _c("div", { key: ii, staticClass: "flex justify-between" }, [
              _c("p", [_vm._v(_vm._s(role.id))]),
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(role.name))]),
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(role.description))]),
              _vm._v(" "),
              _c("div", { staticClass: "cursor-pointer" }, [
                _c(
                  "span",
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "flex justify-between font-bold" }, [
      _c("p", [_vm._v("id")]),
      _vm._v(" "),
...
var render = function() {
  ...
  return _c("div", {}, [
    _c("div", { staticClass: "mx-auto mt-6 pt-4 w-1/4" }, [
      _c("h3", { staticClass: "text-xl mb-5" }, [_vm._v("Login")]),
      _vm._v(" "),
      _c("div", { staticClass: "flex flex-wrap -mx-3 mb-6" }, [
        _c("div", { staticClass: "w-full md:w-full px-3 mb-6" }, [
          _c(
      ...
      _c(
        "a",
        {
          staticClass: "mt-4 text-blue-500 cursor-pointer",
          attrs: { href: "/register" }
        },
...
var render = function() {
  ...
  return _c("div", {}, [
    _c("div", { staticClass: "mx-auto mt-6 pt-4 w-1/4" }, [
      _c("h3", { staticClass: "text-xl mb-5" }, [_vm._v("Register")]),
      _vm._v(" "),
      _c("div", { staticClass: "flex flex-wrap -mx-3 mb-6" }, [
        _c("div", { staticClass: "w-full md:w-full px-3 mb-6" }, [
          _c(
